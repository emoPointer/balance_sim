...
#ifndef BALANCE_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define BALANCE_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // BALANCE_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
